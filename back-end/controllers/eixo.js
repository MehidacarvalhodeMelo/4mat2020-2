...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Eixo.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Eixo.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        const id = req.body._id
        let obj = await Eixo.findByIdAndDelete(id)
