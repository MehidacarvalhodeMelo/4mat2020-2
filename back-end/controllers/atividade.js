...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await Atividade.find()
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Atividade.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Atividade.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        const id = req.body._id
        let obj = await Atividade.findByIdAndDelete(id)
